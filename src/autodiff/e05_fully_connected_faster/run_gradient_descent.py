import numpy as np
from main import Linear, Op, Tanh, UnitVector, Variable, fully_connected, square
...
for iteration in range(100000):
    ...
    for variable in derivable_variables:
        ...
        for flat_index in range(np.prod(variable.value.shape)):
            direction = UnitVector(
                flat_index=flat_index, tensor_shape=variable.value.shape
            )
